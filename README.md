...
- The current bounded writer path is uncompressed; deterministic real RGB→CMYK/N-channel Output-ICC fixtures, Spot/extra-sample sources, non-streamable sources, Photoshop-specific spot metadata and real RIP acceptance remain validation gates.
