...
- Production conversion output is LZW-compressed through a local disk-backed mmap spool, preserving strip-bounded transform RAM and atomic staged verification/commit. Deterministic real RGB→CMYK/N-channel Output-ICC fixtures, Spot/extra-sample sources, non-streamable sources, Photoshop-specific spot metadata and real RIP acceptance remain validation gates.
