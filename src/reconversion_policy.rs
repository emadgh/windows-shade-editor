...
use crate::model::{ChannelAdjustment, ShadeProject};
...
pub fn analyze_replacement_risk(
    ...
    let production_adjustments_modified = production_project
        .adjustments
        .values()
        .any(|adjustment| adjustment != &ChannelAdjustment::default());
