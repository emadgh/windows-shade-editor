...
///
/// LittleCMS exposes concrete packed 16-bit pixel formats for these channel
/// counts. Keeping N in the Rust type prevents a 7-channel transform from being
/// called with a 6- or 8-channel destination buffer. A runtime dispatcher can
/// later wrap these typed transforms for UI-selected target counts.
